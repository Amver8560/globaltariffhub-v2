...
const content = {
  es: {
    ...
    hero_photo_desc: "La IA analiza el producto y sugiere clasificaciones arancelarias para que tomes la decisión con información real.",
    ...
    stats: [
      { n: "164", label: "Países miembro\nde la OMC" },
      { n: "3", label: "Sistemas arancelarios\nintegrados" },
      { n: "4", label: "Módulos\nespecializados" },
      { n: "IA", label: "Clasificación por\nfoto o descripción" },
    ],
    ...
    modules: [
      {
        ...
        desc: "Buscá por foto, descripción o código. La IA analiza el producto y sugiere clasificaciones arancelarias para que tomes la decisión con información real.",
      },
      {
        icon: "📄",
        color: "#C9A84C",
  ...
  en: {
    ...
    hero_photo_desc: "AI analyzes the product and suggests tariff classifications so you can make decisions with real information.",
    ...
    stats: [
      { n: "164", label: "WTO member\ncountries" },
      { n: "3", label: "Integrated tariff\nsystems" },
      { n: "4", label: "Specialized\nmodules" },
      { n: "AI", label: "Classification by\nphoto or description" },
    ],
    ...
    modules: [
      {
        ...
        desc: "Search by photo, description or code. AI analyzes the product and suggests tariff classifications so you can decide with real information.",
      },
      {
        icon: "📄",
        color: "#C9A84C",
