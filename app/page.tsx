...
const T = {
  es: {
    ...
    mission_close:  "En comercio exterior el problema no suele ser la falta de información. Es el exceso de información dispersa. Global Tariff Hub la organiza para ayudarte a tomar mejores decisiones.",
    ...
    problems: [
      { q:"¿Puedo importar este producto?",              a:"Seleccionás país de origen, país de destino y tipo de operación. GTH clasifica el producto con IA, identifica el código HS/NCM/TARIC y te indica si la operación está habilitada en ese corredor comercial." },
      { q:"¿Puedo exportarlo?",                          a:"Indicás el país desde donde exportás y el país de destino. GTH verifica requisitos de entrada, restricciones y documentación necesaria según el par de países seleccionado." },
      { q:"¿Qué impuestos tendría?",                    a:"Según el país de destino y el código arancelario del producto, GTH informa los aranceles orientativos aplicables: derechos de importación, IVA, impuestos internos y otros tributos del país de destino." },
      { q:"¿Necesito certificados?",                    a:"GTH informa qué certificaciones, permisos o licencias previas puede requerir el producto según el país de destino: certificados sanitarios, de origen, normas técnicas, entre otros." },
      { q:"¿Existen restricciones?",                    a:"Verificamos restricciones del par origen-destino: cuotas, licencias, embargos, productos sensibles y posiciones arancelarias con tratamiento especial en ese corredor." },
      { q:"¿Cuál sería el costo total?",                a:"La Calculadora CIF estima el costo real de la operación: precio de compra, flete internacional, seguro, aranceles y tributos del país de destino, antes de negociar." },
      { q:"¿Hay beneficios arancelarios disponibles?",  a:"GTH identifica acuerdos comerciales vigentes entre el país de origen y el de destino (TLCs, SGP, MERCOSUR, UE, etc.) que pueden reducir o eliminar el arancel aplicable." },
    ],
