...
const content = {
  es: {
    ...
    features: [
      { icon: "🔍", title: "Buscador HS / NCM / TARIC", desc: "Encontrá el código arancelario correcto por nombre de producto, descripción o imagen." },
      ...
      { icon: "🤖", title: "Búsqueda por imagen + IA", desc: "Sacá una foto del producto y la IA identifica su código arancelario automáticamente." },
    ],
  ...
  en: {
    ...
    features: [
      { icon: "🔍", title: "HS / NCM / TARIC Search", desc: "Find the right tariff code by product name, description or image." },
      ...
      { icon: "🤖", title: "Image + AI Search", desc: "Take a photo of a product and AI automatically identifies its tariff code." },
    ],
