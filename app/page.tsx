...
const T = {
  es: {
    ...
    problems: [
      { q:"¿Puedo importar este producto?",              a:"Subí una foto o describí el producto. GTH lo clasifica con IA, identifica el código NCM/HS y te indica si la importación está habilitada para Argentina." },
      { q:"¿Puedo exportarlo?",                          a:"GTH detecta el código arancelario y verifica los requisitos de exportación: licencias, restricciones y documentación necesaria para el país de destino." },
      { q:"¿Qué impuestos tendría?",                    a:"Calculamos los aranceles orientativos: DI, TE, IVA, IVA adicional, Ingresos Brutos y percepciones aplicables, según la normativa argentina vigente." },
      { q:"¿Necesito certificados?",                    a:"GTH informa qué certificaciones, permisos o licencias previas requiere el producto: SENASA, INAL, ANMAT, Certificado de Origen, entre otros." },
      { q:"¿Existen restricciones?",                    a:"Verificamos restricciones de importación o exportación, cuotas, licencias automáticas y no automáticas, y posiciones arancelarias con tratamiento especial." },
